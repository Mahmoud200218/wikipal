...
<body id="kt_body" class="app-blank">
    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
                    ...
                    <div class="w-lg-500px p-10">
                        ...
                        <form class="form w-100" method="POST" action="{{ route('register') }}" novalidate="novalidate" id="kt_sign_up_form">
                            ...
                            <div class="row g-3 mb-9">
                                ...
                                <div class="col-md-6">
                                    <!--begin::Google link--->
                                    <a href="{{ route('auth.socialite.redirect', 'google') }}" class="btn btn-flex btn-outline btn-text-gray-700 btn-active-color-primary bg-state-light flex-center text-nowrap w-100">
                                ...
                                <div class="col-md-6">
                                    <!--begin::Facebook link--->
                                    <a href="{{ route('auth.socialite.redirect', 'facebook') }}" class="btn btn-flex btn-outline btn-text-gray-700 btn-active-color-primary bg-state-light flex-center text-nowrap w-100">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="theme-light-show h-15px me-3" viewBox="0 0 320 512" width="50" height="50" fill="#1877F2">
                                            <path d="M279.14 288l14.22-92.66h-88.91V134.25c0-25.35 12.42-50.06 52.24-50.06H295V6.26S261.24 0 229.5 0c-73.42 0-121.31 44.38-121.31 124.72V195.3H56.89V288h51.3v224h100.17V288z" />
                                        </svg>
                            ...
                            <div class="fv-row mb-8">
                                <!--begin::Name-->
                                <x-text-input placeholder="Country" class="form-control bg-transparent" type="country" name="country" :value="old('country')" required />
                                <x-input-error :messages="$errors->get('country')" style="color: red;" class="mt-2" />
                                <!--end::Name-->
                            </div>
                            ...
                            <div class="fv-row mb-8">
                                <!--begin::Name-->
                                <x-text-input placeholder="City" class="form-control bg-transparent" type="city" name="city" :value="old('city')" required />
                                <x-input-error :messages="$errors->get('city')" style="color: red;" class="mt-2" />
                                <!--end::Name-->
                            </div>
                            ...
                            <div class="fv-row mb-8">
                                <label class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="terms" value="not_accept" />
            ...
            <!--begin::Aside-->
            <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2" style="background-image: url(assets/media/logos/back-login.png)">
                <!--begin::Content-->

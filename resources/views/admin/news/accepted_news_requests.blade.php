...
<div class="card mb-5 mb-xl-8 mt-6">
    ...
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bolder fs-3 mb-1">Accepted News Requests</span>
            <span class="text-muted mt-1 fw-bold fs-7">You can view news requests and <strong class="text-danger">Reject</strong> them from here.</span>
        </h3>
                        ...
                        <td class="text-end">
                            <a class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                ...
                                <form action="{{ route('admin.news.status.update', $request->id) }}" method="POST">
                                    ...
                                    <button name="status" type="submit" value="rejected" class="fs-6"><i class="fas fa-times-circle text-danger" style="margin-right: 4px;"></i></button>
                                </form>
                                <!--end::Svg Icon-->
                            </a>
                        </td>

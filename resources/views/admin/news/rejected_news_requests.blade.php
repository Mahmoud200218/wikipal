...
<div class="card mb-5 mb-xl-8 mt-6">
    ...
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bolder fs-3 mb-1">Rejected News Requests</span>
            <span class="text-muted mt-1 fw-bold fs-7">You can view news requests and <strong class="text-danger">Accept</strong> them from here.</span>
        </h3>

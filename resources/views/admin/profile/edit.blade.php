    ...
    <div id="kt_content_container" class="container-xxl">
                ...
                <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                    ...
                    <div class="me-7 mb-4">
                        <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                            @if($admin->avatar)
                            <img src="{{ asset('storage/' . $admin->avatar) }}" alt="image" />
                            @else
                        ...
                        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    <div class="text-gray-900 fs-2 fw-bolder me-1">{{ Auth::guard('admin')->user()->name }}</div>
                                    @if($admin->super_admin == 1)
                                    <div class="btn btn-sm btn-light-info fw-bolder ms-2 fs-8 py-1 px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">Super Admin (Administrator)</div>
                                    @else
                                    <div class="btn btn-sm btn-light-info fw-bolder ms-2 fs-8 py-1 px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">Admin</div>
                                    @endif
                                </div>
                                <!--end::Name-->
                                <!--begin::Info-->
                            ...
                            <div class="d-flex my-4">
                                <a href="{{ route('admin.dashboard') }}" class="btn btn-sm me-2" style="background-color: #DAA520;color:#fff;">Dashboard</a>
                                <!--begin::Menu-->
                            </div>
                            <!--end::Actions-->
                        </div>
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--end::Svg Icon-->
                                            <div class="fs-2 fw-bolder" data-kt-countup="true" data-kt-countup-value="{{ \App\Models\Admin::count() }}" data-kt-countup-prefix="">{{ \App\Models\Admin::count() }}</div>
                                        </div>
                                        <!--end::Number-->
                                        <!--begin::Label-->
                                        <div class="fw-bold fs-6 text-gray-400">Admins</div>
                                        <!--end::Label-->
                                    </div>
                                    <!--end::Stat-->
                                    <!--begin::Stat-->
                                    <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--end::Svg Icon-->
                                            <div class="fs-2 fw-bolder" data-kt-countup="true" data-kt-countup-value="{{ \App\Models\User::count() }}" data-kt-countup-prefix="">{{ \App\Models\User::count() }}</div>
                                        </div>
                                        <!--end::Number-->
                                        <!--begin::Label-->
                                    ...
                                    <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--end::Svg Icon-->
                                            <div class="fs-2 fw-bolder" data-kt-countup="true" data-kt-countup-value="{{ \App\Models\Front\Contact::count() }}" data-kt-countup-prefix="">{{ \App\Models\Front\Contact::count() }}</div>
                                        </div>
                                        <!--end::Number-->
                                        <!--begin::Label-->
                                        <div class="fw-bold fs-6 text-gray-400">Contacts</div>
                                        <!--end::Label-->
                                    </div>
                                    <!--end::Stat-->
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_settings_profile_details">
                <section>
                    <!--begin::Form-->
                    <form method="post" action="{{ route('admin.profile.update') }}" id="kt_account_profile_details_form" class="form" enctype="multipart/form-data">
                        @csrf
                        @method('patch')
                        <!--begin::Card body-->
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    <!--begin::Image input-->
                                    <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url({{ asset('storage/') }})">
                                        <!--begin::Preview existing avatar-->
                                        @if($admin->avatar)
                                        <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{ asset('storage/' . $admin->avatar) }})"></div>
                                        @else
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <x-text-input id="name" name="name" type="text" class="form-control form-control-lg form-control-solid" :value="old('name', $admin->name)" required autofocus autocomplete="name" />
                                </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <x-text-input id="email" name="email" type="email" class="form-control form-control-lg form-control-solid" :value="old('email', $admin->email)" required autocomplete="username" />
                                </div>
                            ...
                            <div class="flex items-center gap-4" style="margin-bottom: 40px;">
                                ...
                                <p
                                    ...
                                    class="text-sm fs-6 flash-success"><Strong style="color: #DAA520;" class="fs-4">Admin</Strong> | {{ __('Profile informations has been saved successfuly.') }}</p>
                                @endif
                            </div>
                    </form>
                        ...
                        <form method="post" action="{{ route('admin.password.update') }}" class="mt-6 space-y-6">
                            ...
                            <div class="flex items-center gap-4" style="margin-bottom: 40px;">
                                ...
                                <p
                                    ...
                                    x-transition
                                    x-init="setTimeout(() => show = false, 2000)"
                                    class="text-sm fs-6 flash-success"><Strong style="color: #DAA520;" class="fs-4">Admin</Strong> | {{ __('Password has been saved successfuly. ') }}</p>
                                @endif
                            </div>
                        </form>
                    </section>

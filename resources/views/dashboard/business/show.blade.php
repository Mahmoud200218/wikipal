...
<div class="">
    <div class="mb-n1 pt-3 mb-lg-n3 pt-lg-6" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
            <h1 class="tit-style" style="text-align: left;">{{ $business->title ?? '' }}</h1>
        </div>
        <!--end::Container-->
    </div>
    ...
    <div class="mb-n1 pt-3 mb-lg-n3 pt-lg-6" id="kt_toolbar">
        <!--begin::Container-->
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
            <P class="tit-desc fs-3">{{ $business->short_title ?? '' }}</P>
            <!--end::Container-->
        </div>
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
            <P class="tit-desc">{{ $business->created_at->diffForHumans() }}</P>
            <!--end::Container-->
        </div>
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <audio id="audioPlayer" controls>
                        <source src="{{ asset('storage/' . $business->podcast ) }}" type="audio/ogg">
                    </audio>
                </div>
                ...
                <!-- Edit Button -->
                <div>
                    <a href="{{ route('dashboard.business.edit', $business->id) }}" class="edit-btn">
                ...
                <!-- Delete Button -->
                <div>
                    <form action="{{ route('dashboard.business.destroy', $business->id) }}" method="POST" id="deleteForm">
                        @csrf
                        @method('DELETE')
        ...
        <div class="col-md-8">
            ...
            <div class="h-100 d-flex flex-column justify-content-between pe-lg-6 mb-lg-0 mb-10">
                <div class="content">
                    ...
                    <div class="mb-3">
                        <img src="{{ asset('storage/' . $business->cover_image ) }}" style="height: 450px; width:600px;" alt="Cover image">
                    </div>
                    <!--end::Video-->
                    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
                        <P class="fw-bold fs-5 text-gray-600 text-dark mt-4 desc">{{ $business->cover_image_description }}</P>
                    </div>
                    @endif
                    <!--begin::Body-->
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <div class="fw-bold fs-5 text-dark-600 text-dark mt-4 desc">
                                        {{ $business->other_image_description }}
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <img src="{{ asset('storage/' . $business->other_image) }}" style="height: 320px; width: 100%; object-fit: cover;" alt="Image">
                                </div>
                            </div>
                            @endif
                            <br><br><br>
                                ...
                                <div class="card-body bg-dark">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item bg-dark">
                                            <p class="text-white pointer">Link1:</p> <a href="{{ $business->source_url_one  }}" target="_blank">{{ $business->source_url_one  }}</a>
                                        </li>
                                        <li class="list-group-item bg-dark">
                                            <p class="text-white pointer">Link2:</p> <a href="{{ $business->source_url_two  }}" target="_blank">{{ $business->source_url_two  }}</a>
                                        </li>
                                        <li class="list-group-item bg-dark">
                                            <p class="text-white pointer">Link3:</p> <a href="{{ $business->source_url_three  }}" target="_blank">{{ $business->source_url_three  }}</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>

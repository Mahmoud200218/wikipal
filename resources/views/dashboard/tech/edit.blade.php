...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Edit Technology</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">
                        <a href="{{ route('dashboard.tech.index') }}" class="text-muted text-hover-primary">Technology</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">Edit Technology</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post" style="margin-top:30px">
        ...
        <div id="kt_content_container" class="container-xxl">
            <form action="{{ route('dashboard.tech.update', $tech->id) }}" method="post" id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data">
                @csrf
                @method('put')
                <!--begin::Aside column-->
                <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body text-center pt-0">
                            <!--begin::Image input-->
                            @if(isset($tech->cover_image))
                            <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true" style="background-image: url({{ asset('storage/' . $tech->cover_image ) }})">
                                @else
                        ...
                        <div class="card-body text-center pt-0">
                            <!--begin::Editor-->
                            <div>
                                <textarea name="cover_image_description" class="form-control mb-2" placeholder="Image Description" style="height: 150px;">{{ old('cover_image_description', $tech->cover_image_description) }}</textarea>
                            </div>
                            <!--end::Editor-->
                            <!--begin::Description-->
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="title" class="form-control mb-2" placeholder="Title" value="{{ old('title', $tech->title) }}" />
                                <!--end::Input-->
                                <!--begin::Description-->
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="short_title" class="form-control mb-2" placeholder="Short Title" value="{{ old('short_title', $tech->short_title) }}" />
                                <!--end::Input-->
                                <!--begin::Description-->
                            ...
                            <div style="margin-bottom: 30px;">
                                ...
                                <!--begin::Editor-->
                                <div>
                                    <textarea name="first_description" id="" class="form-control mb-2" placeholder="First Description" style="height: 200px;">{{ old('first_description', $tech->first_description) }}</textarea>
                                </div>
                                <!--end::Editor-->
                                <!--begin::Description-->
                            ...
                            <div>
                                ...
                                <!--begin::Editor-->
                                <div>
                                    <textarea name="second_description" id="" class="form-control mb-2" placeholder="Second Description" style="height: 150px;">{{ old('second_description',$tech->second_description) }}</textarea>
                                </div>
                                <!--end::Editor-->
                                <!--begin::Description-->
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body text-center pt-0">
                            <!--begin::Image input-->
                            @if(isset($tech->other_image))
                            <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true" style="background-image: url({{ asset('storage/' . $tech->other_image ) }})">
                                @else
                                <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true" style="background-image: url(assets/media/svg/files/blank-image.svg)">
                                    @endif                                <!--begin::Preview existing avatar-->
                                <div class="image-input-wrapper w-150px h-150px"></div>
                        ...
                        <div class="card-body text-center pt-0">
                            <!--begin::Editor-->
                            <div>
                                <textarea name="other_image_description" id="" class="form-control mb-2" placeholder="Other Image Description" style="height: 150px;">{{ old('other_image_description', $tech->other_image_description) }}</textarea>
                            </div>
                            <!--end::Editor-->
                            <!--begin::Description-->
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10">
                                ...
                                <select id="sourceSelect" name="have_source" class="form-select form-select-solid" data-control="select2" data-dropdown-css-class="w-200px" data-placeholder="Select an option">
                                    <option></option>
                                    <option value="yes" {{ $tech->have_source == 'yes' ? 'selected' : '' }}>Yes</option>
                                    <option value="no" {{ $tech->have_source == 'no' ? 'selected' : '' }}>No</option>
                                </select>
                            ...
                            <div id="linksContainer" style="display: none;">
                                <div>
                                    ...
                                    <input id="link1" name="source_url_one" class="form-control mb-2" value="{{ old('source_url_one', $tech->source_url_one) }}" />
                                </div>
                                <div>
                                    <label class="form-label">Link 2</label>
                                    <input id="link2" name="source_url_two" class="form-control mb-2" value="{{ old('source_url_two', $tech->source_url_two) }}" />
                                </div>
                                <div>
                                    <label class="form-label">Link 3</label>
                                    <input id="link3" name="source_url_three" class="form-control mb-2" value="{{ old('source_url_three', $tech->source_url_three) }}" />
                                </div>
                            </div>
                        </div>
                        <!--end::Card body-->
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div>
                                ...
                                <select class="form-select form-select-solid" name="policies" id="policies">
                                    <option value="agree" {{ $tech->policies == 'agree' ? 'selected' : '' }}>I Agree</option>
                                    <option value="disagree" {{ $tech->policies == 'disagree' ? 'selected' : '' }}>I Do Not Agree</option>
                                </select>
                            </div>
                            <!--end::Input group-->

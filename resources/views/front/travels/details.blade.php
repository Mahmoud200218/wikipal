...
<div class="">
    <div class="mb-n1 pt-3 mb-lg-n3 pt-lg-6" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
            <h1 class="tit-style" style="text-align: left;">{{ $travels->title ?? '' }}</h1>
        </div>
        <!--end::Container-->
    </div>
    ...
    <div class="mb-n1 pt-3 mb-lg-n3 pt-lg-6" id="kt_toolbar">
        <!--begin::Container-->
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
            <P class="tit-desc fs-3">{{ $travels->short_title ?? '' }}</P>
            <!--end::Container-->
        </div>
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
            <P class="tit-desc">{{ $travels->created_at->diffForHumans() }}</P>
            <!--end::Container-->
        </div>
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <audio id="audioPlayer" controls>
                        <source src="{{ asset('storage/' . $travels->podcast ) }}" type="audio/ogg">
                    </audio>
                </div>
                @endif
    ...
    <div class="col-md-8" style="max-width: 70%;">
        ...
        <div class="h-100 d-flex flex-column justify-content-between pe-lg-6 mb-lg-0 mb-10">
            <div class="content">
                <!--begin::Video-->
                <div class="mb-3">
                    <img src="{{ asset('storage/' . $travels->cover_image ) }}" style="height: 650px; width:800px;" alt="">
                </div>
                <!--end::Video-->
                <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
                    <P class="fw-bold fs-5 text-gray-600 text-dark mt-4 desc">{{ $travels->cover_image_description }}</P>
                    <!--end::Container-->
                </div>
                <!--begin::Body-->
                ...
                <div class="mb-5" style="width: 80%; margin:60px 0 0 60px">
                    <div class="">
                        <!--begin::Title-->
                        <a href="{{ route('user.overview', $travels->user->id) }}" class="fw-bold fs-4 text-dark-600 text-dark mt-4 desc">
                            By {{ $travels->user->name  }} </a>
                        <p class="line"></p>
                        <!--end::Title-->
                        <!--begin::Text-->
                        <div class="fw-bold fs-2 text-dark-600 text-dark mt-4 desc">
                            {{ $travels->first_description  }}
                        </div>
                        <br><br><br>
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6">
                                <div class="fw-bold fs-5 text-dark-600 text-dark mt-4 desc">
                                    {{ $travels->cover_image_description }}
                                </div>
                            </div>

                            <!-- Image Column -->
                            <div class="col-md-6 mb-3">
                                <img src="{{ asset('storage/' . $travels->other_image) }}" style="height: 320px; width: 100%; object-fit: cover;" alt="Image">
                            </div>
                        </div>
                        <br><br><br>
                        <!-- Description Column -->
                            ...
                            <div class="card-body bg-dark">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item bg-dark">
                                        <p class="text-white pointer">Link1:</p> {{ $travels->source_url_one  }}
                                    </li>
                                    <!-- Reference 2 -->
                                    <li class="list-group-item bg-dark">
                                        <p class="text-white pointer">Link2:</p> {{ $travels->source_url_two  }}
                                    </li>
                                    <!-- Reference 3 -->
                                    <li class="list-group-item bg-dark">
                                        <p class="text-white pointer">Link3:</p> {{ $travels->source_url_three }}
                                    </li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <livewire:comments :model="$travels" />
                </div>
            </div>
        </div>
        <!--end::Feature post-->

...
<div class="tit-style-parent">
    <div class="mb-n1 pt-3 mb-lg-n3 pt-lg-6" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
            <h1 class="tit-style">{{ __('Opinions') }}</h1>
        </div>
        <!--end::Container-->
    </div>
</div>
    ...
    <div class="col-md-8" style="margin-right: 50px;">
        ...
        <div class="mb-10">
            ...
            <div class="ps-lg-6 mt-md-0 mt-17">
                <div>
                    <div class="fw-bold fs-5 mt-4 text-gray-600 text-dark tit">{{ Str::limit($opinion->first_description, 300, '..') }}</div>
                    <div class="py-4 d-flex flex-lg-row">
                        ...
                        <img src="{{ asset('storage/' . $opinion->cover_image) }}" style="height: 180px; width:200px;margin-left:50px;" alt="">
                    </div>
                </div>
            </div>
            <hr>

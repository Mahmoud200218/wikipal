    ...
    <div class="col-md-8" style="margin-right: 50px;">
        ...
        <div class="mb-10">
            ...
            <div class="ps-lg-6 mt-md-0 mt-17">
                <div>
                    <div class="fw-bold fs-5 mt-4 text-gray-600 text-dark tit">{{ Str::limit($story->first_description, 300, '..') }}</div>
                    <div class="py-4 d-flex flex-lg-row">
                        <a href="{{ route('stories_details', $story->id) }}" class="fw-bolder text-dark mb-4 tit">{{ Str::limit($story->title, 60, '..') }}</a>
                        <img src="{{ asset('storage/' . $story->cover_image) }}" style="height: 180px; width:200px;margin-left:50px;" alt="">
                    </div>
                </div>
            </div>
            <hr>

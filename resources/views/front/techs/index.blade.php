...
<div class="tit-style-parent">
    <div class="mb-n1 pt-3 mb-lg-n3 pt-lg-6" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
            <h1 class="tit-style">Technology</h1>
        </div>
        <!--end::Container-->
    </div>
</div>
    ...
    <div class="col-md-8" style="margin-right: 50px;">
        ...
        <div class="mb-10">
            ...
            <div class="ps-lg-6 mt-md-0 mt-17">
                <div>
                    <div class="fw-bold fs-5 mt-4 text-gray-600 text-dark tit">{{ Str::limit($tech->first_description, 300, '..') }}</div>
                    <div class="py-4 d-flex flex-lg-row">
                        <a href="{{ route('techs_details', $tech->id) }}" class="fw-bolder text-dark mb-4 tit">{{ Str::limit($tech->title, 60, '..') }}</a>
                        <img src="{{ asset('storage/' . $tech->cover_image) }}" style="height: 180px; width:200px;margin-left:50px;" alt="">
                    </div>
                </div>
            </div>
            <hr>

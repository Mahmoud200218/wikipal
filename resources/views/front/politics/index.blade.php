...
<div class="tit-style-parent">
    <div class="mb-n1 pt-3 mb-lg-n3 pt-lg-6" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
            <h1 class="tit-style">Politics</h1>
        </div>
        <!--end::Container-->
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-8" style="margin-right: 50px;">
        ...
        @if($politics->isNotEmpty())
        @foreach($politics as $politic)
        <div class="mb-10">
            <!-- Additional Posts -->
            <div class="ps-lg-6 mt-md-0 mt-17">
                <div>
                    <div class="fw-bold fs-5 mt-4 text-gray-600 text-dark tit">{{ Str::limit($politic->first_description, 300, '..') }}</div>
                    <div class="py-4 d-flex flex-lg-row">
                        <a href="{{ route('politics_details', $politic->id) }}" class="fw-bolder text-dark mb-4 tit">{{ Str::limit($politic->title, 60, '..') }}</a>
                        <img src="{{ asset('storage/' . $politic->cover_image) }}" style="height: 180px; width:200px;margin-left:50px;" alt="">
                    </div>
                </div>
            </div>
            <hr>
